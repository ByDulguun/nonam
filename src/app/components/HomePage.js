    ...
    <div className="lg:h-[100%] h-full overflow-hidden grid gap-20 lg:flex lg:flex-row-reverse">
      ...
      <div className="w-full h-fit lg:h-[100vh]">
        <div className="px-4 grid gap-4 h-fit overflow-hidden pt-48 lg:pt-12 lg:w-[100%] lg:px-24">
          ...
          <div
            className="flex items-end gap-1 border-[#b3b3b3] border-b-1 w-fit cursor-pointer"
          ...
          >
            <div className="flex items-center gap-2 group relative overflow-hidden w-[126px] h-[24px]">
              ...
              />
              <p className="text-sm text-white font-medium leading-[1] group-hover:-bottom-12 bottom-0 left-6 duration-700 absolute z-40 py-1">
                GET IN
              </p>
              <p className="text-sm text-white font-medium leading-[1] group-hover:-top-12 top-1.5 right-0 duration-700 absolute z-40">
                TOUCH
              </p>
              <p className="text-sm text-white font-medium leading-[1] absolute group-hover:bottom-0 -bottom-12 left-6 duration-700 z-40 py-1">
                GET IN
              </p>
              <p className="text-sm text-white font-medium leading-[1] absolute group-hover:top-0.5 -top-12 right-0 duration-700 z-40 py-1">
                TOUCH
              </p>
            </div>
          </div>
